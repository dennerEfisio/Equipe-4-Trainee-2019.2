    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="row">
            <a href="<?php echo URL_BASE."local/adicionar";?>" class="btn btn-info"> + Adicionar Local</a>
        </div>
        <div class="buscarCrud mt-3">
            <div>
            <a href="<?php echo URL_BASE."local"; ?>" class="btn btn-info">Ver Todos</a>
            </div>
            <div>
                ...
                <tbody>
                    ...
                    <tr class="linha">
                        ...
                        <td class="conteudoTabela botoes">
                            <a href="<?php echo URL_BASE."local/mostrar/".$local->id; ?>" class="btn btn-info">Ver mais</a>
                        </td>
                    </tr>
                    <?php  } ?>
                </tbody>
