    ...
    <div class=" container mt-5 mb-5">
        ...
        <div class="row">
            <a href="<?php echo URL_BASE."categoria/adicionar";?>" class="btn btn-info"> + Adicionar Categoria</a>
        </div>
        <div class="buscarCrud mt-3">
            <div>
                <a href="<?php echo URL_BASE."categoria"; ?>" class="btn btn-info">Ver Todos</a>
            </div>
            <div>
                    ...
                    <?php foreach($categorias as $categoria){ ?>
                            <tr class="linha">
                                ...
                                <td class="conteudoTabela botoes">
                                    <a href="<?php echo URL_BASE."categoria/mostrar/".$categoria->id; ?>" class="btn btn-info">Ver mais</a>
                                </td>
                            </tr>
        ...
        <div class="row mt-3">
            <a href="<?php echo URL_BASE."administrador" ; ?>" class="btn btn-info">Voltar</a>
        </div>
    </div>
